...
def main(local_rank):
    ...
    def model_fn(x, t, y=None, z_features=None, selected_indexes=None):
    ...
    if not os.path.isfile(features_mean_sup_file):
        ...
        features_p, labels_associated = get_mean_closest_sup(features_z, labels_associated, k=args.k_closest)
    ...
    features_n = features_file['arr_0'].shape[0]
    features_z = features_file['arr_0']
    # features_z = features_file["arr_1"]
    #
    ...
    # features_z = features_file['arr_1']
    # labels_associated = features_file['arr_2']
    def design_cond_fn(inputs, t, y=None, z_features=None, selected_indexes=None):
        assert y is not None
        with th.enable_grad():
            x = inputs[0]
            ...
            match1 = similarity_match(z_x_0, z_features.detach())
    ...
    while len(all_images) * args.batch_size < args.num_samples:
        ...
        z_features = th.from_numpy(features_z).to(dist_util.dev())
