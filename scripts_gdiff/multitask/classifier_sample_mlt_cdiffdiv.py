...
from guided_diffusion.script_util_mlt import create_model_and_diffusion_mlt_cdiffdiv # diffusion - classification conflict + classification - diversity conflict
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt_cdiffdiv(
