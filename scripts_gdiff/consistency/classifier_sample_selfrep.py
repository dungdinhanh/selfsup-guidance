...
def main(local_rank):
    ...
    features = np.load("eval_models/imn64/features.npz")['arr_0']
    ...
    def cond_fn(x, t, y=None):
        ...
        with th.enable_grad():
            ...
            s_features = th.from_numpy(features[random_selected_indexes]).to(x_in.get_device())

            similarity_match(logits, s_features)
