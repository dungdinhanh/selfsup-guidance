...
from eds_guided_diffusion.script_util_mlt import (
    ...
    classifier_defaults,
    create_model_and_diffusion_mlt4,
    create_classifier,
...
# DDIM for conditional (without updating conflict for denoising gradient)
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_mlt4(
    ...
    diffusion.u_weight = args.uweight
    diffusion.u_weightc = args.uweightc
