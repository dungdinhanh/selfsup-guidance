...
from eds_guided_diffusion.script_util_mlt import (
    ...
    classifier_defaults,
    create_model_and_diffusion_cdiv_stopearly,
    create_classifier,
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_cdiv_stopearly(
    ...
    diffusion.stop_early = args.stop_early
    diffusion.weight = args.uweight
