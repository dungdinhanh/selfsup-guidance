...
from eds_guided_diffusion.script_util_robust import create_model_and_diffusion_lsim_sch_wconf
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_lsim_sch_wconf(
...
def create_argparser():
    defaults = dict(
        ...
        logdir="",
        eps=0.1,
        lsim_path="models/IM_ls_w2v.npz"
    )
