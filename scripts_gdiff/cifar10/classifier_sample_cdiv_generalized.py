...
from guided_diffusion.script_util_32 import create_model_and_diffusion_cifar10_cdiv_generalized
import datetime
...
def main(local_rank):
    ...
    model, diffusion = create_model_and_diffusion_cifar10_cdiv_generalized(
    ...
    classifier_dict['out_channels'] = 10
    ...
    diffusion.weight_1wcdiv = args.cdiv
    diffusion.weight_1wcdiff = args.cdiff
    diffusion.weight_1wdivc = args.divc
    diffusion.weight_1wdiffc = args.diffc
