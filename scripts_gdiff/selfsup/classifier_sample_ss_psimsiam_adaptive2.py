...
def main(local_rank):
    ...
    def cond_fn(x, t, y=None):
        ...
        with th.enable_grad():
            ...
            if t[0] > 200:
                cls_scale = args.classifier_scale * 0.01
            elif t[0] > 150:
                cls_scale = args.classifier_scale * 0.1
            elif t[0] > 100:
                cls_scale = args.classifier_scale * 0.5
            elif t[0] > 50:
                cls_scale = args.classifier_scale * 1.0
            elif t[0] > 25:
                cls_scale = args.classifier_scale * 2.0
            elif t[0] > 10:
                cls_scale = args.classifier_scale * 4.0
            else:
                cls_scale = args.classifier_scale * 5.0

            return th.autograd.grad(loss, x_in)[0] * cls_scale
