...
--classifier_path runs/selfsup_training_distanceaware_noT/psimsiam300000_IM256_wl_maxp700/models/model150000.pt \
 ...
 --logdir runs/sampling_ss/IMN64/conditional/scale${scale}_wl_maxp700/ "
echo ${cmd}
eval ${cmd}
done
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling_ss/IMN64/conditional/scale${scale}_wl_maxp700/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done
