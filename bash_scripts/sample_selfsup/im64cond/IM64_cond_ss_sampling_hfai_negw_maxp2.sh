...
--classifier_path runs/selfsup_training_distanceaware_noT/psimsiam300000_IM256_wneg0.5_maxp1000/models/model150000.pt \
 --model_path models/64x64_diffusion.pt $SAMPLE_FLAGS \
 --logdir runs/sampling_ss/IMN64/conditional/scale${scale}_wneg0.5_maxp1000/ "
echo ${cmd}
eval ${cmd}
done
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling_ss/IMN64/conditional/scale${scale}_wneg0.5_maxp1000/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done
