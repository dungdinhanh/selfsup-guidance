...
for scale in "${scales[@]}"
do
cmd="python scripts_gdiff/selfsup/classifier_sample_ss_psimsiam_pathchecking.py $MODEL_FLAGS --classifier_scale ${scale}  \
--classifier_path runs/selfsup_training_distanceaware_noT/psimsiam150000/models/model149999.pt \
