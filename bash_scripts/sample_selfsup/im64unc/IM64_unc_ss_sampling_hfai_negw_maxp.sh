...
#scales=( "0.3" "0.5" "0.7" "1.0" "2.0" "4.0")
scales=( "0.4" "0.6")
...
--classifier_path runs/selfsup_training_distanceaware_noT/psimsiam300000_IM256_wneg0.5_maxp700/models/model150000.pt \
 --model_path models/64x64_diffusion_unc.pt $SAMPLE_FLAGS \
 --logdir runs/sampling_ss/IMN64/unconditional/scale${scale}_wneg0.5_maxp700/ "
echo ${cmd}
eval ${cmd}
done
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet64_labeled.npz \
 runs/sampling_ss/IMN64/unconditional/scale${scale}_wneg0.5_maxp700/reference/samples_50000x64x64x3.npz"
echo ${cmd}
eval ${cmd}
done
