...
--resume_checkpoint runs/selfsup_training_distanceaware_noT_0distanceT0/pretrainedcls50000/models/model049999.pt"
...
cmd="python scripts_gdiff/selfsup/analyse/simsiam_check_distance_2image_t0.py --data_dir path/to/imagenet \
