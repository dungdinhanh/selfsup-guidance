...
cmd="python scripts_gdiff/selfsup/classifier_train_selfsup_distanceaware.py --data_dir path/to/imagenet --logdir runs/selfsup_training_distanceaware/scratch $TRAIN_FLAGS $CLASSIFIER_FLAGS"
echo ${cmd}
eval ${cmd}