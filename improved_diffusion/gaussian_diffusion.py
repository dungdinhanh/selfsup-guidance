...
Modify to include classifer during sampling (for guidance)
"""
...
class GaussianDiffusion:
    ...
    def condition_mean(self, cond_fn, p_mean_var, x, t, model_kwargs=None):
        ...
        """
        gradient, guidance = cond_fn(x, self._scale_timesteps(t), **model_kwargs)
        new_mean = (
            p_mean_var["mean"].float() + p_mean_var["variance"] * guidance['scale'] * gradient.float()
        )
        return new_mean
