...
cmd="python scripts_gdiff/selfsup/analyse/simsiam/main_lincls_normdiff_pdiff.py\
  ...
  --world-size 1 --rank 0  --pretrained runs/selfsup_training_distanceaware_noT/psimsiam300000_IM256/models/model299999.pt  \
  --lars --image_size 256 --save_folder runs/linear_eval/im256_lin_negw"
