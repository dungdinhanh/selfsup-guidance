...
cmd="python scripts_gdiff/selfsup/analyse/simsiam/main_lincls_normdiff_pdiff.py\
  ...
  --world-size 1 --rank 0  --pretrained runs/selfsup_training_distanceaware_noT/psimsiam150000_IM128/models/model149999.pt  \
  --lars --image_size 128 --save_folder runs/linear_eval/im128_lin_negw"
