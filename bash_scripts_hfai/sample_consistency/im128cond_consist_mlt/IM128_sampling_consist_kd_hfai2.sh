...
--logdir runs/sampling_selfrep_kd_mlt/IMN128/conditional/scale${scale}/ --features eval_models/imn128/reps2.npz"
echo ${cmd}
eval ${cmd}
done
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet128_labeled.npz \
 runs/sampling_selfrep_kd_mlt/IMN128/conditional/scale${scale}/reference/samples_50000x128x128x3.npz"
echo ${cmd}
eval ${cmd}
done
