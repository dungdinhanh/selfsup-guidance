...
--classifier_path eval_models/simsiam_0099.pth.tar --model_path models/256x256_diffusion.pt  \
 --logdir runs/sampling_selfrep_simsiam/IMN256/conditional/scale${scale}/ --features eval_models/imn256_simsiam/reps2.npz"
echo ${cmd}
eval ${cmd}
done
...
cmd="python evaluations/evaluator_tolog.py reference/VIRTUAL_imagenet256_labeled.npz \
 runs/sampling_selfrep_simsiam/IMN256/conditional/scale${scale}/reference/samples_50000x256x256x3.npz"
echo ${cmd}
eval ${cmd}
done
