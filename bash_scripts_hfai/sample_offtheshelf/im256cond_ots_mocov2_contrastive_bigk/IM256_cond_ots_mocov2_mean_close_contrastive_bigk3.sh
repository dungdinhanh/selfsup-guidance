...
cmd="python script_odiff/mocov2_meanclose_contrastive_sup_instance_sample_transform.py $MODEL_FLAGS --classifier_scale ${scale}  \
 ...
 --logdir runs/sampling_ots_bigk_contrastive/IMN256/kc${kc}/conditional/scale${scale}_mocov2_mean_close/ --features eval_models/imn256_mocov2/reps3.npz --k_closest 10"
echo ${cmd}
eval ${cmd}
done
done
