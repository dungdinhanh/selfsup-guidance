...
def create_model_diffusion_unconditional(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    model = create_model(
        ...
        channel_mult=channel_mult,
        learn_sigma=learn_sigma,
        class_cond=False, # class_cond always True
        use_checkpoint=use_checkpoint,
        attention_resolutions=attention_resolutions,
        num_heads=num_heads,
        num_head_channels=num_head_channels,
...
def create_model_and_diffusion_classifier_free2(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    diffusion = create_gaussian_diffusion_clsfree2(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
        noise_schedule=noise_schedule,
        use_kl=use_kl,
...
def create_gaussian_diffusion_clsfree2(
    *,
    steps=1000,
    learn_sigma=False,
    sigma_small=False,
    ...
    if not timestep_respacing:
        timestep_respacing = [steps]
    return GaussianDiffusionClassFree2(
        use_timesteps=space_timesteps(steps, timestep_respacing),
        betas=betas,
        model_mean_type=(
            gd.ModelMeanType.EPSILON if not predict_xstart else gd.ModelMeanType.START_X
...
def create_model_and_diffusion_classifier_free2contrastive(
    image_size,
    class_cond,
    learn_sigma,
    num_channels,
    ...
    diffusion = create_gaussian_diffusion_clsfree2contrastive(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
        noise_schedule=noise_schedule,
        use_kl=use_kl,
...
def create_gaussian_diffusion_clsfree2contrastive(
    *,
    steps=1000,
    learn_sigma=False,
    sigma_small=False,
    ...
    if not timestep_respacing:
        timestep_respacing = [steps]
    return GaussianDiffusionClassFree2Contrastive(
        use_timesteps=space_timesteps(steps, timestep_respacing),
        betas=betas,
        model_mean_type=(
            gd.ModelMeanType.EPSILON if not predict_xstart else gd.ModelMeanType.START_X
