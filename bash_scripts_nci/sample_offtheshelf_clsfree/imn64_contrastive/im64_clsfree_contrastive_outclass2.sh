...
#PBS -o output_nci/log_clsfree_contrastive_tunec12.txt
#PBS -e output_nci/error_clsfree_contrastive_tunec12.txt
...
do
  for kc in "${kcs[@]}"
  do
cmd="WORLD_SIZE=1 RANK=0 MASTER_IP=127.0.0.1 MASTER_PORT=29610 MARSV2_WHOLE_LIFE_STATE=0 python3 script_odiff/classifier_free/classifier_free_sample2_contrastive_outclass.py $MODEL_FLAGS --cond_model_scale ${scale}  \
