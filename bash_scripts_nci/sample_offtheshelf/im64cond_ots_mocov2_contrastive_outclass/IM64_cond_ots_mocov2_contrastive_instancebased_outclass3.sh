...
#PBS -o output_nci2/log_outclass3.txt
#PBS -e output_nci2/error_outclass3.txt
...
do
cmd="WORLD_SIZE=1 RANK=0 MASTER_IP=127.0.0.1 MASTER_PORT=29512 MARSV2_WHOLE_LIFE_STATE=0 python3 script_odiff/mocov2_meanclose_contrastive_outclass_sup_instance_sample_transform_nci.py \
